...
public class AutoClicker extends HackModule {
    ...
    public void onTick() {
        ...
        if (tickCounter >= nextClickAt) {
            ...
            if (mc.crosshairPickEntity != null && mc.gameMode != null) {
                mc.gameMode.attackEntity(mc.player, mc.crosshairPickEntity);
                mc.player.swing(net.minecraft.world.InteractionInteractionHand.MAIN_HAND);
            }
            tickCounter = 0;
            scheduleNextClick();
        }
